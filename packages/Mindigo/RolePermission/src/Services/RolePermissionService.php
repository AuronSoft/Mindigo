        ...
        return [
            ...
            'content' => [
                ...
                'permissions' => [
                    ...
                    'subjects.view' => __('Mindigo-role-permission::app.permissions.subjects.view'),
                    'subjects.create' => __('Mindigo-role-permission::app.permissions.subjects.create'),
                    'subjects.update' => __('Mindigo-role-permission::app.permissions.subjects.update'),
                    'subjects.delete' => __('Mindigo-role-permission::app.permissions.subjects.delete'),
                    'course-categories.view' => __('Mindigo-role-permission::app.permissions.course_categories.view'),
                    'course-categories.create' => __('Mindigo-role-permission::app.permissions.course_categories.create'),
                    'course-categories.update' => __('Mindigo-role-permission::app.permissions.course_categories.update'),
                    'course-categories.delete' => __('Mindigo-role-permission::app.permissions.course_categories.delete'),
                    'classrooms.view' => __('Mindigo-role-permission::app.permissions.classrooms.view'),
                    'classrooms.create' => __('Mindigo-role-permission::app.permissions.classrooms.create'),
                    'classrooms.update' => __('Mindigo-role-permission::app.permissions.classrooms.update'),
                    'classrooms.manage_students' => __('Mindigo-role-permission::app.permissions.classrooms.manage_students'),
                    'classrooms.delete' => __('Mindigo-role-permission::app.permissions.classrooms.delete'),
            ...
            'learner' => [
                ...
                'permissions' => [
                    ...
                    'learning-tools.use' => __('Mindigo-role-permission::app.permissions.learning_tools.use'),
                    'learning-resources.manage' => __('Mindigo-role-permission::app.permissions.learning_tools.manage_resources'),
                ],
            ],
            'support' => [
