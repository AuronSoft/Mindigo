            ...
            @else
                ...
                <div class="sidebar-group" data-sidebar-group data-group-name="@lang('Mindigo-dashboard::app.group_content')">
                    ...
                    <div class="sidebar-submenu hidden gap-1 py-1 pl-13" data-sidebar-submenu>
                        ...
                        @endif
                        @if(Route::has('admin.teacher-applications.index') && ($currentUser?->isAdmin() ?? false))
                            <a href="{{ route('admin.teacher-applications.index') }}" class="sidebar-submenu-item flex min-h-9 items-center gap-2 rounded-xl px-3 text-xs font-extrabold {{ request()->routeIs('admin.teacher-applications.*') ? 'bg-green-50 text-green-700' : 'text-slate-500 hover:bg-green-50 hover:text-green-700' }} no-underline" data-sidebar-search-item data-search-label="@lang('Mindigo-dashboard::app.teacher_applications')"><x-heroicon-o-user-plus class="h-4 w-4 shrink-0" /><span>@lang('Mindigo-dashboard::app.teacher_applications')</span></a>
                        @endif
                ...
                <div class="sidebar-group" data-sidebar-group data-group-name="@lang('Mindigo-dashboard::app.group_operations')">
                    ...
                    <div class="sidebar-submenu hidden gap-1 py-1 pl-13" data-sidebar-submenu>
                        ...
                        @endif
                        @if(Route::has('admin.exam-cutover.index') && ($currentUser?->isAdmin() ?? false))
                            <a href="{{ route('admin.exam-cutover.index') }}" class="sidebar-submenu-item flex min-h-9 items-center gap-2 rounded-xl px-3 text-xs font-extrabold {{ request()->routeIs('admin.exam-cutover.*') ? 'bg-green-50 text-green-700' : 'text-slate-500 hover:bg-green-50 hover:text-green-700' }} no-underline" data-sidebar-search-item data-search-label="@lang('Mindigo-exam-management::app.cutover.title')"><x-heroicon-o-arrow-path class="h-4 w-4 shrink-0" /><span>@lang('Mindigo-exam-management::app.cutover.title')</span></a>
                        @endif
