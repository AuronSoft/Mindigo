            ...
            <section class="min-w-0 rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-900/[0.03]" id="exams">
                ...
                <div class="overflow-x-auto rounded-2xl border border-slate-200">
                    <table class="w-full min-w-[760px] border-collapse bg-white">
                        ...
                        <tbody>
                            <tr><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Đề luyện thi THPT 2026 - Toán 01</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Toán học</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">1,248</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">7.4</td><td class="border-b border-slate-200 px-4 py-3.5"><span class="inline-flex min-h-6 items-center rounded-full bg-green-100 px-2.5 text-[11px] font-black text-green-800">@lang('Mindigo-dashboard::app.published')</span></td></tr>
                            <tr><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Kiểm tra Sinh học - Di truyền</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Sinh học</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">684</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">6.9</td><td class="border-b border-slate-200 px-4 py-3.5"><span class="inline-flex min-h-6 items-center rounded-full bg-amber-100 px-2.5 text-[11px] font-black text-amber-800">@lang('Mindigo-dashboard::app.reviewing')</span></td></tr>
                            <tr><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Ngân hàng Anh văn B1 - Reading</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">Tiếng Anh</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">932</td><td class="border-b border-slate-200 px-4 py-3.5 text-sm font-extrabold text-slate-700">8.1</td><td class="border-b border-slate-200 px-4 py-3.5"><span class="inline-flex min-h-6 items-center rounded-full bg-green-100 px-2.5 text-[11px] font-black text-green-800">@lang('Mindigo-dashboard::app.published')</span></td></tr>
                            <tr><td class="px-4 py-3.5 text-sm font-extrabold text-slate-700">Đề đánh giá năng lực - Logic</td><td class="px-4 py-3.5 text-sm font-extrabold text-slate-700">Tư duy</td><td class="px-4 py-3.5 text-sm font-extrabold text-slate-700">510</td><td class="px-4 py-3.5 text-sm font-extrabold text-slate-700">7.7</td><td class="px-4 py-3.5"><span class="inline-flex min-h-6 items-center rounded-full bg-sky-100 px-2.5 text-[11px] font-black text-sky-800">@lang('Mindigo-dashboard::app.scheduled')</span></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
