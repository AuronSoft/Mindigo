...
<div id="MindigoIdOverlay" class="hidden fixed inset-0 z-[9999] bg-green-50 overflow-hidden" style="font-family:'Be Vietnam Pro',sans-serif;">
    ...
    <div class="absolute top-0 left-0 right-0 px-10 py-5 flex items-center justify-between z-20">
        <div class="flex items-center gap-2">
            <div class="w-7 h-7 bg-gradient-to-br from-green-600 to-green-400 rounded-full flex items-center justify-center">
                <svg width="14" height="14" viewBox="0 0 200 220" fill="none">
                    <circle cx="105" cy="145" r="90" fill="white"/>
                    <circle cx="82" cy="135" r="14" fill="#14532d"/>
                    <circle cx="128" cy="135" r="14" fill="#14532d"/>
                </svg>
            </div>
