...
return [
    ...
    'onboarding' => [
        ...
        'classroom' => [
            ...
            'activity_total' => '660 phút học tập',
            'course_one' => 'Tiếng Anh giao tiếp',
            'course_one_meta' => 'Hoàn thành 4 bài học',
            'course_two' => 'Luyện tập kỹ năng',
            'course_two_meta' => 'Điểm trung bình 92%',
            'stat_label' => 'LỚP HỌC CỦA BẠN',
            'stat_unit' => 'hoạt động',
            'stat_change' => '+12% tuần này',
            'notice_title' => 'Đã tìm thấy tuần học hiệu quả nhất',
            'notice_meta' => '8 hoạt động đã hoàn thành',
        ],
        'progress' => [
            ...
            'journey_label' => 'LỘ TRÌNH CỦA BẠN',
            'journey_title' => 'Hành trình học tập tuần này',
            'task_one' => 'Hoàn thành bài học nền tảng',
            'task_one_meta' => 'Đã hoàn thành hôm nay',
            'task_two' => 'Thử thách kỹ năng tiếp theo',
            'task_two_meta' => 'Sẵn sàng để bắt đầu',
            'recommendation' => 'GỢI Ý CHO BẠN',
            'course_title' => 'Kỹ năng giao tiếp hiện đại',
            'reward_title' => 'Bạn vừa nhận phần thưởng mới',
            'reward_meta' => 'Hoàn thành chuỗi học tập 7 ngày',
        ],
    ],
