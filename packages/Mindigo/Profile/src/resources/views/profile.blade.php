...
@section('title', 'Tài khoản của tôi — MindigoHRM')
            ...
            <div>
                <div class="profile-breadcrumb">
                    <a href="{{ route('dashboard') }}">
                        @lang('Mindigo-profile::app.dashboard')
                    </a>
                    <svg viewBox="0 0 24 24">
                        <polyline points="9 18 15 12 9 6"/>
                    </svg>
                    <span>
                        @lang('Mindigo-profile::app.my_account')
                    </span>
                </div>
        ...
        <aside class="profile-side">
            ...
            <div class="profile-meta-list">
                <div class="profile-meta-item">
                    ...
                    <div>
                        <div class="profile-meta-label">
                            @lang('Mindigo-profile::app.department')
                        </div>

                        <div class="profile-meta-val">
                            {{ Auth::user()->department ?? __('Mindigo-profile::app.none') }}
                        </div>
                    </div>
                </div>
                <div class="profile-meta-item">
                    ...
                    <div>
                        <div class="profile-meta-label">
                            @lang('Mindigo-profile::app.office')
                        </div>

                        <div class="profile-meta-val">
                            {{ Auth::user()->office ?? __('Mindigo-profile::app.none') }}
                        </div>
                    </div>
                </div>
                <div class="profile-meta-item">
                    ...
                    <div>
                        <div class="profile-meta-label">@lang('Mindigo-profile::app.hire_date')</div>
                        <div class="profile-meta-val">
                ...
                <div class="profile-meta-item">
                    ...
                    <div>
                        <div class="profile-meta-label">@lang('Mindigo-profile::app.direct_manager')</div>
                        <div class="profile-meta-val">
                            {{ Auth::user()->manager->name ?? __('Mindigo-profile::app.none') }}
                        </div>
                    </div>
                </div>
                <div class="profile-meta-item">
                    ...
                    <div>
                        <div class="profile-meta-label">@lang('Mindigo-profile::app.phone')</div>
                        <div class="profile-meta-val">
                            {{ Auth::user()->phone ?? __('Mindigo-profile::app.none') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="profile-main">
            <div class="profile-tab-panel active" id="panel-ho-so">
                <form id="profile-form" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="profile-form-card">
                        <div class="profile-form-card-title">@lang('Mindigo-profile::app.basic_information')</div>
                        <div class="profile-form-grid profile-grid-2">
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="first_name">@lang('Mindigo-profile::app.first_name') *</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="last_name">@lang('Mindigo-profile::app.last_name') *</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="language">@lang('Mindigo-profile::app.language')</label>
                                <select class="profile-select" id="language" name="language">
                                    <option value="vi" {{ old('language', Auth::user()->language) === 'vi' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.vietnamese')
                                    </option>
                                    <option value="en" {{ old('language', Auth::user()->language) === 'en' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.english')
                                    </option>
                                </select>
                            </div>

                            <div class="profile-form-group">
                                <label class="profile-form-label" for="phone">@lang('Mindigo-profile::app.phone')</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="date_of_birth">@lang('Mindigo-profile::app.date_of_birth')</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="hire_date">@lang('Mindigo-profile::app.hire_date')</label>
                    ...
                    <div class="profile-form-card">
                        <div class="profile-form-card-title">@lang('Mindigo-profile::app.work_information')</div>
                        <div class="profile-form-grid profile-grid-3">
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="job_title">@lang('Mindigo-profile::app.job_title')</label>
                                <input class="profile-input" type="text" id="job_title" name="job_title"
                                    value="{{ old('job_title', Auth::user()->job_title) }}"
                                    placeholder="@lang('Mindigo-profile::app.enter_job_title')"/>
                            </div>

                            <div class="profile-form-group">
                                <label class="profile-form-label" for="occupation">@lang('Mindigo-profile::app.occupation')</label>
                                <input class="profile-input" type="text" id="occupation" name="occupation"
                                    value="{{ old('occupation', Auth::user()->occupation) }}"
                                    placeholder="@lang('Mindigo-profile::app.enter_occupation')"/>
                            </div>

                            <div class="profile-form-group">
                                <label class="profile-form-label" for="department">@lang('Mindigo-profile::app.department_area')</label>
                                <select class="profile-select" id="department" name="department">
                                    <option value="">@lang('Mindigo-profile::app.select_option')</option>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="office">@lang('Mindigo-profile::app.office')</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="position">@lang('Mindigo-profile::app.position')</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="manager_id">@lang('Mindigo-profile::app.direct_manager')</label>
                                <select class="profile-select" id="manager_id" name="manager_id">
                                    <option value="">@lang('Mindigo-profile::app.no_manager')</option>
                    ...
                    <div class="profile-form-card">
                        <div class="profile-form-card-title">@lang('Mindigo-profile::app.contact_additional_information')</div>
                        <div class="profile-form-grid profile-grid-2">
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="email_work">@lang('Mindigo-profile::app.work_email')</label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="email_personal">@lang('Mindigo-profile::app.personal_email')</label>
                                <input class="profile-input" type="email" id="email_personal" name="email_personal"
                                    ...
                                    pattern="^[^@]+@gmail\.com$"
                                    title="@lang('Mindigo-profile::app.personal_email_title')"/>
                            </div>

                            <div class="profile-form-group profile-col-full">
                                <label class="profile-form-label" for="bio">@lang('Mindigo-profile::app.bio')</label>
            ...
            <div class="profile-tab-panel" id="panel-email">
                <form method="POST" action="{{ route('profile.notifications') }}">
                    ...
                    @method('PUT')
                    <div class="profile-form-card">
                        <div class="profile-form-card-title">@lang('Mindigo-profile::app.email_notification_settings')</div>
                        <div class="profile-form-grid profile-grid-2">
                            <div class="profile-form-group profile-col-full">
                                <label class="profile-form-label">@lang('Mindigo-profile::app.receive_attendance_notifications')</label>
                                <select class="profile-select" name="notif_attendance">
                                    <option value="all" {{ optional($employee->notificationPreference)->notif_attendance === 'all' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.all')
                                    </option>
                                    <option value="daily" {{ optional($employee->notificationPreference)->notif_attendance === 'daily' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.daily')
                                    </option>
                                    <option value="none" {{ optional($employee->notificationPreference)->notif_attendance === 'none' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.turn_off')
                                    </option>
                                </select>
                            </div>

                            <div class="profile-form-group profile-col-full">
                                <label class="profile-form-label">@lang('Mindigo-profile::app.receive_payroll_notifications')</label>
                                <select class="profile-select" name="notif_payroll">
                                    <option value="monthly" {{ optional($employee->notificationPreference)->notif_payroll === 'monthly' ? 'selected' : '' }}>
                                        @lang('Mindigo-profile::app.monthly')
                                    </option>
            ...
            <div class="profile-tab-panel" id="panel-bao-mat">
                <form method="POST" action="{{ route('profile.password') }}">
                    ...
                    @method('PUT')
                    <div class="profile-form-card">
                        <div class="profile-form-card-title">@lang('Mindigo-profile::app.change_password')</div>
                        <div class="profile-form-grid profile-grid-2">
                            <div class="profile-form-group profile-col-full">
                                <label class="profile-form-label" for="current_password">
                                    @lang('Mindigo-profile::app.current_password')
                                </label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="password">
                                    @lang('Mindigo-profile::app.new_password')
                                </label>
                            ...
                            <div class="profile-form-group">
                                <label class="profile-form-label" for="password_confirmation">
                                    @lang('Mindigo-profile::app.confirm_password')
                                </label>
                ...
                <div class="profile-danger-zone" style="margin-top:14px">
                    <div class="profile-danger-title">@lang('Mindigo-profile::app.danger_zone')</div>

                    <div class="profile-danger-row">
                        <div>
                            <div class="profile-danger-row-label">
                                @lang('Mindigo-profile::app.suspend_account')
                            </div>
                            <div class="profile-danger-row-desc">
                                @lang('Mindigo-profile::app.suspend_account_desc')
                            </div>
                        </div>
                    ...
                    <div class="profile-danger-row">
                        <div>
                            ...
                            <div class="profile-danger-row-desc">
                                @lang('Mindigo-profile::app.delete_account_desc')
                            </div>
                        </div>
