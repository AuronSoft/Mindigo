...
return [
    'home_redesign' => [
        ...
        'test_title_1' => 'Take tests &',
        'test_title_2' => 'get result',
        'test_highlight' => 'instant',
        'test_description' => 'Complete focused assessments and receive clear results immediately, so you can understand your progress and keep improving with confidence.',
        'test_illustration_alt' => 'Student completing an assessment beside a large clock',
        'features_title' => 'Specially features are only for you',
        'features_title_lines' => ['Specially', 'features are', 'only for you'],
        ...
        'private_title_1' => 'Smart classes',
        'private_title_2' => 'with instructor',
        'private_highlight' => 'in private',
        'private_description' => 'Learn directly with dedicated instructors in focused private classes designed around your goals, pace and learning needs.',
        'private_illustration_alt' => 'Learners joining a private online class with an instructor',
        'feature_cards' => [
