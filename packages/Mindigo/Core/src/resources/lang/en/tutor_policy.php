...
return [
    ...
    'meta' => [
        ...
        'version' => 'Version 1.0',
        'scope' => 'Applies to tutors, teachers, and teaching collaborators',
    ],
    ...
    'sections' => [
        ...
        [
            'id' => 'screening',
            'title' => '2. Screening, interview, and evaluation',
            'paragraphs' => [
                'Eligible applications may proceed through screening, interviews, or competency evaluation depending on the teaching role and operational needs.',
                'Evaluation may include subject expertise, pedagogy, communication, professional ethics, and ability to use the LMS.',
            ],
        ],
        [
            'id' => 'approval',
            'title' => '3. Teaching access provisioning',
            'paragraphs' => [
                'Only applicants who pass the review process may receive teacher or tutor access on the platform.',
                'Teaching access may be suspended or revoked if policy violations, quality issues, or conduct risks affect learners or the system.',
            ],
        ],
        [
            'id' => 'teaching',
