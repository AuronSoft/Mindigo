...
return [
    ...
    'hero' => [
        ...
        'heading_1' => 'Cách đơn giản hơn để',
        'heading_2' => 'quản lý đào tạo',
        'heading_3' => 'trên một nền tảng LMS',
        'heading_4' => 'xây dựng khóa học',
        'heading_5' => 'theo dõi tiến độ',
        'floating_instructor' => 'Cố vấn học tập',
        'floating_instructor_name' => 'Nguyễn Minh',
        'floating_live_class' => 'Lớp học đã sẵn sàng',
        'floating_join' => 'Vào lớp',
        'floating_profile' => 'Xem hồ sơ',
        'floating_active' => 'Hoạt động',
        'floating_students' => 'Học viên',
        'floating_students_joined' => '128K+ học viên',
        'floating_progress' => 'Tiến độ khóa học',
        'floating_online' => '128 học viên trực tuyến',
    ...
    'virtual_exam' => [
        'eyebrow' => 'Tiếp cận học viên bằng những buổi học trực tuyến chất lượng',
        'headline_before' => 'Giảng dạy',
        'headline_highlight' => 'trực tuyến',
        'headline_after' => 'với mọi công cụ trong một nơi',
        'description' => 'Tổ chức lớp học sinh động, kết nối với học viên theo thời gian thực và quản lý mọi tương tác trong một phòng học Mindigo liền mạch.',
        'email_placeholder' => 'Địa chỉ email của bạn',
        'class_title' => 'Lớp học trực tiếp của cô Anna',
        'class_meta' => '18 tháng 8 · Đã ghi hình 26:32',
        'recording' => 'Đang ghi hình',
        'teacher_alt' => 'Giảng viên đang dạy lớp học trực tuyến',
        'teacher_name' => 'Cô Anna',
        'participant_alt' => 'Học viên trong lớp học trực tuyến',
        'participant_names' => ['Sara', 'James', 'John', 'Bạn'],
        'controls' => ['microphone' => 'Micrô', 'camera' => 'Máy ảnh', 'screen' => 'Chia sẻ màn hình'],
        'share' => 'Chia sẻ bài học',
        'messages' => 'Tin nhắn',
        'messages_desc' => 'Trao đổi với mọi người trong lớp và duy trì kết nối xuyên suốt buổi học.',
        'chat' => [
            ['name' => 'Can', 'time' => '09:23', 'message' => 'Xin chào, mọi người học bài thế nào rồi?'],
            ['name' => 'Melissa', 'time' => '09:25', 'message' => 'Bài giảng rất dễ hiểu, cảm ơn cô!'],
            ['name' => 'Selin', 'time' => '09:26', 'message' => 'Cô giải thích lại ví dụ này được không ạ?'],
            ['name' => 'Anna', 'time' => '09:28', 'message' => 'Được chứ, chúng ta cùng xem lại nhé.'],
        ],
