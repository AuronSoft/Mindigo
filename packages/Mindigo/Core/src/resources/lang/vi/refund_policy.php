...
return [
    ...
    'sections' => [
        ...
        [
            ...
            'paragraphs' => [
                'Một số trường hợp không đủ điều kiện hoàn tiền để đảm bảo tính công bằng, phòng chống lạm dụng và duy trì chất lượng dịch vụ.',
            ],
            'items' => [
                'Bạn đã sử dụng đáng kể dịch vụ, đã tạo/xuất nhiều đề thi, dùng hạn mức AI, tải dữ liệu, tổ chức lớp học hoặc khai thác lợi ích chính của gói.',
                'Yêu cầu hoàn tiền phát sinh sau thời hạn được công bố, trừ khi pháp luật hoặc thỏa thuận riêng có quy định khác.',
                'Tài khoản bị tạm ngưng hoặc chấm dứt do vi phạm Điều khoản Sử dụng, gian lận, lạm dụng, tấn công hệ thống hoặc vi phạm quyền của bên thứ ba.',
                'Bạn không còn nhu cầu sử dụng, quên hủy gia hạn, chọn sai gói hoặc không đọc kỹ mô tả gói trong khi dịch vụ đã được cung cấp đúng.',
                'Các khoản phí triển khai, tư vấn, tùy biến, đào tạo, tích hợp, di chuyển dữ liệu hoặc dịch vụ đã thực hiện theo thỏa thuận riêng.',
            ],
        ],
        [
            'id' => 'trial',
            'title' => '4. Dùng thử, Khuyến mãi và Mã giảm giá',
            'paragraphs' => [
                'Các gói dùng thử miễn phí, mã khuyến mãi, ưu đãi giới hạn thời gian hoặc gói được tài trợ có thể có điều kiện riêng. Khi hết thời gian dùng thử, việc gia hạn hoặc chuyển sang gói trả phí sẽ tuân theo thông tin hiển thị tại thời điểm đăng ký.',
            ],
            'items' => [
                'Phần giá trị được giảm giá hoặc tặng miễn phí thường không được quy đổi thành tiền mặt.',
                'Nếu bạn được hoàn tiền cho giao dịch có dùng mã giảm giá, số tiền hoàn tối đa là số tiền thực tế đã thanh toán.',
                'Ưu đãi đặc biệt cho tổ chức có thể không được hoàn tiền nếu hợp đồng hoặc báo giá đã quy định rõ.',
            ],
        ],
        [
            'id' => 'subscriptions',
            'title' => '5. Gia hạn và Hủy Gói',
            'paragraphs' => [
                'Nếu gói dịch vụ có cơ chế gia hạn, người dùng hoặc tổ chức có trách nhiệm kiểm tra chu kỳ thanh toán, email thông báo và cấu hình tài khoản trước ngày gia hạn.',
            ],
            'items' => [
        ...
        [
            'id' => 'organization',
            'title' => '6. Gói Tổ chức và Hợp đồng Riêng',
            'paragraphs' => [
        ...
        [
            'id' => 'tax',
            'title' => '10. Hóa đơn, Thuế và Chứng từ',
            'paragraphs' => [
                'Nếu giao dịch đã xuất hóa đơn, việc hoàn tiền hoặc điều chỉnh phí có thể cần thực hiện theo quy định về hóa đơn, thuế và kế toán hiện hành. Người dùng hoặc tổ chức có trách nhiệm phối hợp cung cấp thông tin cần thiết để xử lý chứng từ.',
            ],
        ],
        [
            'id' => 'updates',
