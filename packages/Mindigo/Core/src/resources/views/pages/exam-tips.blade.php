                ...
                <section data-exam-tip-section>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        @foreach($featuredPosts as $post)
                            ...
                            <article id="exam-tip-post-{{ $post['id'] }}" data-exam-tip-card data-featured="1" data-category="{{ $post['category'] }}" data-search="{{ e($post['title'] . ' ' . $post['excerpt'] . ' ' . implode(' ', $post['tags']) . ' ' . $post['category_label']) }}" class="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition hover:border-green-200 hover:shadow-md">
                                ...
                                <h3 class="mb-2 text-base font-black leading-snug text-gray-900 transition group-hover:text-green-600">{{ $post['title'] }}</h3>
