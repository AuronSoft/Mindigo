...
<div class="question-builder" data-question-builder>
    ...
    <div class="question-studio-layout">
        <aside class="question-studio-sidebar">
            <div>
                ...
                <div class="question-part-list">
                    <a href="#question-part-content" class="question-part-item is-active" data-question-part-link="content">@lang('Mindigo-question-bank::app.part_content')</a>
                    <a href="#question-part-answers" class="question-part-item" data-question-part-link="answers">@lang('Mindigo-question-bank::app.part_answers')</a>
                    <a href="#question-part-review" class="question-part-item" data-question-part-link="review">@lang('Mindigo-question-bank::app.part_review')</a>
                </div>
            </div>

            <div>
                <p class="question-studio-label">@lang('Mindigo-question-bank::app.question_index_label')</p>
                <div class="question-mini-index" data-question-index></div>
            </div>
        ...
        <section class="question-studio-main">
            <p class="question-studio-label" id="question-item-1" data-question-index-target>@lang('Mindigo-question-bank::app.question_list_label')</p>

    <section class="question-builder-card is-highlight" id="question-part-content" data-question-part="content">
    ...
    <section class="question-builder-card" data-option-panel id="question-part-answers" data-question-part="answers">
        <div class="question-section-head">
            <span>02</span>
            <div>
    ...
    <section class="question-builder-card hidden" data-short-answer-panel data-question-part="answers">
        <div class="question-section-head">
            <span>02</span>
            <div>
    ...
    <section class="question-builder-card hidden" data-essay-panel data-question-part="answers">
        <div class="question-section-head">
            <span>02</span>
            <div>
    ...
    <section class="question-builder-card" id="question-part-review" data-question-part="review">
        <div class="question-section-head">
            <span>03</span>
            <div>
    ...
    <div class="question-studio-footer">
        <div class="question-studio-submit-actions">
