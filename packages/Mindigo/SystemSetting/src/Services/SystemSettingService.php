    ...
    public function definitions(): array
    {
        return [
            'general' => [
                ...
                'settings' => [
                    'site_name' => ['label' => __('Mindigo-system-setting::app.settings.site_name'), 'type' => 'string', 'default' => 'Mindigo LMS'],
            ...
            'notification' => [
                ...
                'settings' => [
                    ...
                    'mail_from_name' => ['label' => __('Mindigo-system-setting::app.settings.mail_from_name'), 'type' => 'string', 'default' => 'Mindigo LMS'],
                ],
            ],
            'ai_security' => [
