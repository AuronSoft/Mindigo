...
<div class="flex min-h-screen flex-col bg-slate-50">
    <header class="sticky top-0 z-10 border-b border-slate-200 bg-white/95 px-6 py-4 backdrop-blur">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2"><a href="{{ route('course-platform.analytics') }}" class="inline-flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-sm font-black text-slate-700 no-underline hover:bg-slate-50"><x-heroicon-o-chart-bar class="h-4 w-4" />@lang('teacher-course::analytics.title')</a>@if(auth()->user()->isTeacher())<a href="{{ route('teacher.profile.edit') }}" class="inline-flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-sm font-black text-slate-700 no-underline hover:bg-slate-50"><x-heroicon-o-user-circle class="h-4 w-4" />@lang('teacher-course::reviews.edit_profile')</a>@endif<a href="{{ route('teacher.courses.create') }}" class="inline-flex h-10 items-center gap-2 rounded-xl bg-green-600 px-4 text-sm font-black text-white no-underline shadow-sm transition hover:bg-green-500">
