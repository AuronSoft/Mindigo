...
@section('title', __('student-practice::app.history').' - Auronsoft LMS')
@section('styles')
...
<div class="min-h-screen bg-slate-50">
    ...
    <main class="p-6">
        ...
        <section class="mt-6 overflow-hidden rounded-xl border border-slate-200 bg-white">
            <div class="overflow-x-auto"><table class="w-full min-w-180 text-left"><thead><tr class="border-b border-slate-200 text-xs font-bold text-slate-500"><th class="px-5 py-4">@lang('student-practice::app.title')</th><th class="px-5 py-4">@lang('student-practice::app.questions')</th><th class="px-5 py-4">@lang('student-practice::app.score')</th><th class="px-5 py-4">@lang('student-practice::app.completed_at')</th><th class="px-5 py-4"></th></tr></thead><tbody class="divide-y divide-slate-100">
