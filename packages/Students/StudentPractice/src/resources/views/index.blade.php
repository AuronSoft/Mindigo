...
<div class="min-h-screen bg-slate-50">
    <header class="border-b border-slate-200 bg-white px-6 py-4">
        ...
        <div class="flex flex-wrap items-end justify-between gap-3">
            ...
            <div class="flex gap-2"><a href="{{ route('student.practice.adaptive.index') }}" class="rounded-lg border border-green-200 bg-green-50 px-4 py-2 text-xs font-black text-green-700 no-underline hover:bg-green-100">@lang('student-practice::app.adaptive.title')</a><a href="{{ route('student.practice.skills.index') }}" class="rounded-lg bg-green-600 px-4 py-2 text-xs font-black text-white no-underline hover:bg-green-700">@lang('student-practice::app.skill_practice.catalog')</a><a href="{{ route('student.practice.history') }}" class="rounded-lg border border-slate-300 px-4 py-2 text-xs font-black text-slate-700 no-underline hover:border-green-300 hover:text-green-700">@lang('student-practice::app.history')</a></div>
        </div>
    </header>
