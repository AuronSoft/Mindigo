...
@section('title', __('student-practice::app.skills.title').' - Mindigo LMS')
@section('styles')
...
<div class="min-h-screen bg-slate-50">
    ...
    <main class="p-6">
        ...
        <section class="overflow-hidden rounded-xl border border-slate-200 bg-white"><div class="overflow-x-auto"><table class="w-full min-w-[860px] text-left"><thead><tr class="border-b border-slate-200 text-xs font-bold text-slate-500"><th class="px-5 py-4">@lang('student-practice::app.skills.code')</th><th class="px-5 py-4">@lang('student-practice::app.skills.name')</th><th class="px-5 py-4">@lang('student-practice::app.subject')</th><th class="px-5 py-4">@lang('student-practice::app.topic')</th><th class="px-5 py-4">@lang('student-practice::app.questions')</th><th class="px-5 py-4">@lang('student-practice::app.skills.status')</th><th class="px-5 py-4"></th></tr></thead><tbody class="divide-y divide-slate-100">
