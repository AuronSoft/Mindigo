...
@section('title', __('student-live-session::app.title') . ' · Auronsoft LMS')
    ...
    <div class="flex min-h-screen flex-col bg-slate-50">
        ...
        <header class="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-slate-200 bg-white/90 px-6 py-4 backdrop-blur">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="max-sm:hidden sm:grid h-11 w-11 place-items-center rounded-2xl bg-rose-50 text-rose-500">
