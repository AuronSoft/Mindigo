...
@section('title', __('student-notebook::app.title') . ' · Auronsoft LMS')
...
<div class="flex min-h-screen flex-col bg-slate-50">
    ...
    <header class="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-slate-200 bg-white/90 px-6 py-4 backdrop-blur">
        <div>
            <p class="text-[11px] font-black uppercase tracking-widest text-green-700">@lang('student-notebook::app.area')</p>
